...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","TG_style_name_bio")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","Vip_Raja_G")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","FRIEND_KI_MASTI")
BOT_NAME = os.environ.get("BOT_NAME","CHATBOT")
START_IMG = os.environ.get("START_IMG","https://telegra.ph/file/e213b59bb8e670c771cea.jpg")
